...
export const featuresArr: IFeatureDefinition[] = [
  ...
  { label: "clipboard", entry: "vs/editor/contrib/clipboard/clipboard" },
  {
    label: "codeAction",
    entry: "vs/editor/contrib/codeAction/codeActionContributions",
  },
  { label: "codelens", entry: "vs/editor/contrib/codelens/codelensController" },
  {
    label: "colorDetector",
    entry: "vs/editor/contrib/colorPicker/colorDetector",
  },
  { label: "comment", entry: "vs/editor/contrib/comment/comment" },
  { label: "contextmenu", entry: "vs/editor/contrib/contextmenu/contextmenu" },
  { label: "coreCommands", entry: "vs/editor/browser/controller/coreCommands" },
  { label: "cursorUndo", entry: "vs/editor/contrib/cursorUndo/cursorUndo" },
  { label: "dnd", entry: "vs/editor/contrib/dnd/dnd" },
  { label: "find", entry: "vs/editor/contrib/find/findController" },
  { label: "folding", entry: "vs/editor/contrib/folding/folding" },
  { label: "fontZoom", entry: "vs/editor/contrib/fontZoom/fontZoom" },
  { label: "format", entry: "vs/editor/contrib/format/formatActions" },
  {
  ...
  { label: "gotoError", entry: "vs/editor/contrib/gotoError/gotoError" },
  {
    label: "gotoLine",
    entry: "vs/editor/standalone/browser/quickOpen/gotoLine",
  },
  { label: "hover", entry: "vs/editor/contrib/hover/hover" },
  {
  ...
  { label: "links", entry: "vs/editor/contrib/links/links" },
  { label: "multicursor", entry: "vs/editor/contrib/multicursor/multicursor" },
  {
  ...
  { label: "rename", entry: "vs/editor/contrib/rename/rename" },
  { label: "smartSelect", entry: "vs/editor/contrib/smartSelect/smartSelect" },
  { label: "snippets", entry: "vs/editor/contrib/snippet/snippetController2" },
  { label: "suggest", entry: "vs/editor/contrib/suggest/suggestController" },
  {
  ...
  { label: "transpose", entry: "vs/editor/contrib/caretOperations/transpose" },
  {
